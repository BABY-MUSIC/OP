...
BOT_TOKEN = getenv("BOT_TOKEN", "8094524393:AAGs4If0W4q6D2Z6dP6_dexlFeU25eofwkQ")
...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "bab_log")


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6977190988").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BABY-MUSIC/OP",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/BABY09_WORLD"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/+OL6jdTL7JAJjYzVl"
...
raw_sessions = getenv("STRING_SESSIONS", "BQD7IGgAxJqlqss5aMAJJDNEQP0WdKFuRwMgKOQ_9D2LQLPDqSEOVx4RskP1FIH59vcu6aqjthJZrXCDHXfbcDh8vXJ9I-uTCJqUF_6rOGDdeE44DlvQhFI4rLMrcGbUtgrizwOA0JmmvO7Ezf6laewqrItI1Jz8v2x3Ope_MRK-8ZsJOqT-3KLVxN3u4Hd-IIoiTSAg1Je5-Klsf76RKCMS-5J9A0by_L4U_Uav6mlxDdKLisrPYl-Rju1MuDPxa13E6MYzCRkDBnsP5SVSnpI0Rl9i7Gsw6zuayHyRT4lyV1fny4JG9VZs7F1PwJ1IRG9eS-9Am4kmu6eajMDaxHXBik6shwAAAAHI_A9dAA")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/ucp9mf.jpg",  # This is the file id of the photo you can also put the url of photo
)
